...
export class CommentStore {
  ...
  editComment = async (comment) => {
    ...
    ].comments.findIndex((commentObject) => commentObject.id === editCommentId);

    this.store.core.editCommentFromCurrentHistoryItem(commentIndex, {
      screenshot: params.screenshot ? params.screenshot : null,
      screenshot_width: params.screenshot ? params.screenshot_width : null,
      screenshot_height: params.screenshot ? params.screenshot_height : null,
      chart: params.chart ? params.chart : null,
      comment: comment,
      time: comment_time,
      edited: true,
