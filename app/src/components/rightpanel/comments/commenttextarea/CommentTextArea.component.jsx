  ...
  const renderCommentFooter = () => (
    ...
    >
      <Text fontWeight="bold" fontSize="xs" opacity="0.6">
        ...
        <Kbd style={{ marginRight: "10px" }}>C</Kbd> anywhere in the app to add
        a comment.
      </Text>
      <HStack spacing="1">
        <Box>
                ...
                <PopoverCloseButton
                  ...
                  onClick={() => {
                    store.track.trackEvent(
                      ...
                      {
                        event_type: "Click",
                        event_action: "Close markdown info",
                      }
                    );
                  }}
                />
          ...
          <IconButton
            ...
            onClick={() => {
              store.track.trackEvent(
                ...
                {
                  event_type: "Click",
                  event_action: store.comment.isCommentListVisible
                    ? "Hide comments"
                    : "Show comments",
                }
              );
      ...
      {store.comment.isCommentListVisible && (
        ...
        >
          <Textarea
            ...
            borderRadius="8px"
            padding="10px"
            paddingRight={store.comment.editMode ? "170px" : "136px"}
            border="none"
            resize="none"
          ...
          <HStack position="absolute" right="12px" bottom="12px">
                  ...
                  <IconButton
                    ...
                    onClick={() => {
                      ...
                      store.track.trackEvent(
                        ...
                        {
                          event_type: "Click",
                          event_action: "Remove chart from comment",
                        }
                      );
                    }}
                    icon={
                  ...
                  <IconButton
                    ...
                    onClick={() => {
                      ...
                      store.track.trackEvent(
                        ...
                        {
                          event_type: "Click",
                          event_action: "Remove screenshot from comment",
                        }
                      );
                    }}
                    icon={
            ...
            <Tooltip label={store.comment.editMode ? "Save edits" : "Comment"}>
              <IconButton
                size="sm"
                zIndex="2"
                borderRadius="4px"
...
const ObservedCommentTextArea = observer(CommentTextArea);
export default ObservedCommentTextArea;
