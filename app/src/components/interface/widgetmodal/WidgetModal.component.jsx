          ...
          <ComponentStatsComponent
            ...
            demoData={[
              ...
              },
              {
                id: 2,
                node_count: 34,
                largest_connections: [{ label: "edge 5", count: 3 }],
                largest_nodes: [{ label: "node 5", entries: [2, 4, 5] }],
              },
              {
                id: 3,
                node_count: 14,
                largest_connections: [{ label: "edge 4", count: 2 }],
                largest_nodes: [{ label: "node 4", entries: [4, 5] }],
              },
              {
                id: 4,
                node_count: 4,
      ...
      <Box height="225px" width="100%">
        <CustomScroll style={{ paddingLeft: "10px", paddingRight: "10px" }}>
          <SimpleGrid columns={3} spacing={2}>
            ...
            {statTypes.type === "chart" && statTypes.chartType !== "radar" && (
              <FormControl
                backgroundColor={
                  colorMode === "light" ? "blackAlpha.200" : "whiteAlpha.200"
                }
                ...
                >
                  ...
                  <Tooltip label="These values will be shown on the chart instead of 'First group', 'Second group' etc. and they will be used to group the element values.">
                    <Select
                      ...
                      variant="filled"
                    >
                      {store.stats.getElementValues(true).map((entry) => (
                        <option
            ...
            {statTypes.type === "chart" &&
              ...
              store.stats.newChartProps.element_values !== "types" && (
                <FormControl
                  backgroundColor={
                    colorMode === "light" ? "blackAlpha.200" : "whiteAlpha.200"
                  }
                ...
                >
                  ...
                  <Tooltip label="These values will define which types of nodes you want to explore.">
                    ...
                    >
                      ...
                      {[
                        ...store.graph.currentGraphData.perspectivesInGraph,
                      ].map((entry) => (
                        <option
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    >
                      {entry["type"] === "chart"
                        ? renderChart(entry["chartType"], entry["title"])
                        : renderExampleStats(entry["statType"])}
                    </Box>
    ...
    >
      ...
      >
        <ModalHeader width="100%">
          <Heading textAlign="center" size="md" padding="0" marginTop="10px">
            Widget Selection
          </Heading>
          <IconButton
            position="absolute"
