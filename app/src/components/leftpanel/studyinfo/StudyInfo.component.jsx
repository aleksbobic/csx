  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text fontSize="xs" fontWeight="bold" opacity="0.7" width="100%">
          Study name:
        </Text>
        ...
        >
          ...
          >
            <EditablePreview
              ...
              paddingRight="10px"
            />
            <EditableTextarea size="xs" width="100%" paddingLeft="8px" />
          </Editable>
        </Tooltip>
        <Text fontSize="xs" fontWeight="bold" opacity="0.7" width="100%">
          Study author
        ...
        <Text fontSize="sm" paddingLeft="8px" width="100%" fontWeight="bold">
        ...
        {store.core.isStudyPublic && (
          <>
            ...
            <Text
              ...
              width="100%"
            >
              Anyone with this link can access your study in presentation mode.
            </Text>
          </>
        )}
      </VStack>
...
const ObservedStudyInfo = observer(StudyInfo);
export default ObservedStudyInfo;
