  ...
  const renderColorSchemeOptionElements = () => {
    const colorSchemas = [
      ...
      },
      {
        ...
        tooltip: "Color nodes based on the number of neighbours they have",
      },
    ];
    ...
    return (
      <HStack justifyContent="space-between" width="100%" padding="5px">
        ...
        <Tooltip label="Select property used for node colors.">
          <Select
            size="sm"
            value={store.graphInstance.nodeColorScheme[store.core.currentGraph]}
            onChange={(e) => {
        ...
        <Box>
          <Menu closeOnSelect={false} zIndex="3">
            ...
            <MenuList
              ...
              minWidth="200px"
            >
              {store.core.visibleDimensions[store.core.currentGraph].map(
                (feature) => (
                  <MenuItem
      ...
      <AccordionItem>
        ...
        <AccordionPanel padding="10px 0 0">
          ...
          >
            ...
            {renderLabelOptions(!store.graphInstance.labels.isVisible)}
          </VStack>
