...
export function SurveyInfoModal(props) {
  ...
  const getSurveyLink = () => {
    ...
    return isEnvSet("VITE_SURVEY_LINK");
  };
    ...
    >
      <VStack width="400px" position="relative" alignItems="flex-start">
        ...
        {isEnvSet("VITE_SURVEY_MESSAGE") ? (
          ...
          <Text fontSize="sm">
            Hey it seems like you&#39;re enjoying using CSX! How about you fill
            out a short feedback form and enable me to make it even better?
          </Text>
        )}
