  ...
  return (
    ...
    >
      ...
      <Text
        ...
        width="70%"
      >
        It seems like there are no results for your query. Here's a cute tiny{" "}
        {emptySearchAnimalType} to make you feel better:
      </Text>
      {emptySearchImage && (
        <Image
          // src={searchImage1}
      ...
      >
        ...
        />{" "}
        If you don't see any suggestions for your search, it will most likely be
        empty. Don't give up. Try again! There's also a helpful hint below the
        search bar.
      </Text>
    </VStack>
  );
