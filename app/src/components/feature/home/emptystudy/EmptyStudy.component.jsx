  ...
  return (
    ...
    >
      ...
      <Text
        ...
        width="70%"
      >
        It seems like the study you tried accessing doesn't exist anymore.
        Here's a cute tiny {emptySearchAnimalType} to make you feel better:
      </Text>
      {emptySearchImage && (
        <Image
          // src={searchImage1}
      ...
      >
        ...
        />{" "}
        If you tried accessing a study you created make sure to save the study
        before leaving Collaboration Spotting X.
      </Text>
      <Text
        textAlign="center"
        color={colorMode === "light" ? "blackAlpha.500" : "whiteAlpha.500"}
      ...
      >
        ...
        />{" "}
        If you tried accessing a study someone shared with you make sure they
