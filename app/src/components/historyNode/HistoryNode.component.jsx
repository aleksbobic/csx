            ...
            icon={
              <XMarkIcon
                style={{
                  ...
                  height: "14px",
                  color:
                    (data.colorMode === "light" || data.isActive) && "white",
                }}
              />
            }
          />
          ...
          <VStack width="100%" height="100%">
            <Tooltip label={data.title}>
              <Text
                ...
                color={data.colorMode === "light" && data.isActive && "white"}
            ...
            >
              <Flex justifyContent="center">
                <Box
                  backgroundColor={
                    data.isActive ? "blackAlpha.200" : "whiteAlpha.200"
                  }
                  borderRadius="4px"
                  padding="2px 6px"
                  display="flex"
