...
const overviewSchemaNode = ({ id, data }) => {
        ...
        {data.position === "left" &&
          data.properties.filter(
            ...
            <HStack
              ...
              justifyContent="space-between"
              style={{
                marginTop: data.addedProperties.length === 0 ? "0px" : "10px",
              }}
            >
              <Select
                className="nodrag"
              ...
              <Tooltip label="Add selected feature as anchor property">
                <IconButton
                  ...
                  onClick={() =>
                    data.addProperty(
                      document.getElementById(`${id}_property_selector`).value
                    )
                  }
                  _hover={{
  ...
  return (
    <>
      ...
      >
        ...
        <Tooltip label={"Remove link node"}>
          <IconButton
            ...
            _hover={{ opacity: 1 }}
            onClick={() =>
              data.label ? data.setLink(data.label, id) : data.removeLink(id)
            }
      ...
      {data.isAnchor && data.position === "left" && renderAddLinkButton("left")}
      {((data.isAnchor &&
