...
import Comments from "components/rightpanel/comments/Comments.component";
import CustomScroll from "components/customscroll/CustomScroll.component";
import { HistoryFlow } from "components/rightpanel/historyflow/HistoryFlow.component";
import PropTypes from "prop-types";
import { RootStoreContext } from "stores/RootStore";
import SchemaFlow from "components/rightpanel/schemaflow/SchemaFlow.component";
import { SchemaList } from "components/rightpanel/schemalist/SchemaList.component";
import SerpComponent from "components/rightpanel/serp/Serp.component";
import TableComponent from "components/rightpanel/table/Table.component";
import WidgetGrid from "components/rightpanel/widgetgrid/WidgetGrid.component";
...
function RightPanel(props) {
  ...
  useEffect(() => {
    if (store.graph.currentGraphData.activeTableData) {
      setCsvData(getCsvData(store.graph.currentGraphData.activeTableData));
      setCsvHeaders(
  ...
  const renderTabPanels = () => {
    return (
      <TabPanels width="100%" padding="0 10px 10px" height="100%" ref={ref}>
              ...
              onChange={(e) => {
                if (e.target.checked) {
                  ...
                  setVisibleProperties([
                    ...visibleProperties.filter((value) => value !== feature),
                  ]);
                }
              }}
            >
  ...
  const renderTabButtons = () => {
    return (
      ...
      >
        <HStack>
          {isEnvFalse("VITE_DISABLE_DATASET_DOWNLOAD") && (
    ...
    >
      ...
      >
        ...
        <Tabs
          ...
          paddingBottom={store.comment.isCommentListVisible ? 0 : "80px"}
          paddingTop={
            activeTab === 3 &&
        ...
        <Flex
          position={store.comment.isCommentListVisible ? "initial" : "absolute"}
...
const ObservedRightPanel = observer(RightPanel);
export default ObservedRightPanel;
