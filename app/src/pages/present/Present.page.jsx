              ...
              <Center>
                <VStack padding="15%">
                  ...
                  >
                    ...
                    <Text fontSize="sm">{slide.author}</Text>
                  </HStack>
                </VStack>
              </Center>
            </Box>
        ...
        case "markdownmedia":
          return (
            <Box
              ...
              height="100%"
              width="80%"
              data-transition={slide.transition ? slide.transition : "slide"}
            >
              <HStack flexDirection={flexDirection} height="100%" width="100%">
                <Box
                  overflow="hidden"
                  width="70%"
                  height="auto"
                ...
                >
                  <Image src={slide.chart ? slide.chart : slide.screenshot} />
                </Box>

                <Box textAlign={textAlign} width="30%" height="auto" zIndex="5">
                  <Markdown
                    className="mkdslide"
                    children={slide.content}
                    remarkPlugins={[remarkGfm]}
